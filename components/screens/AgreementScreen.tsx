        ...
        <SafeAreaView className="flex-1 bg-black">
            <View className="flex-1 px-8 pt-12 pb-8">
                ...
                <View className="mb-12">
                    ...
                    <Text className="text-white font-headline font-black text-4xl tracking-widest mt-6 uppercase">
                        FOCUS AGREEMENT
                    </Text>
                ...
                <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
                    <View className="space-y-8">
                        ...
                        <View className="bg-white/5 p-6 border border-white/10 mt-4">
                            <Text className="text-white/40 font-label text-[10px] leading-4 tracking-widest uppercase mb-4">
                                PROMINENT DISCLOSURE ACKNOWLEDGED
                            </Text>
                            <Text className="text-white/40 font-headline text-[10px] leading-5">
                ...
                <View className="pt-8">
                    <TouchableOpacity
                        ...
                        className={`${permissions.accessibility && permissions.overlay ? 'bg-white' : 'bg-white/10 border border-white/20'} h-16 items-center justify-center`}
                        activeOpacity={0.9}
                    >
                        <Text className={`${permissions.accessibility && permissions.overlay ? 'text-black' : 'text-white'} font-headline font-black text-sm uppercase tracking-widest`}>
                            {!permissions.accessibility ? 'GRANT ACCESSIBILITY' : !permissions.overlay ? 'GRANT OVERLAY' : 'I AGREE AND COMMIT'}
                        </Text>
                    </TouchableOpacity>
                    <Text className="text-white/20 font-label text-[10px] text-center mt-4 uppercase tracking-widest">
                        FAILURE TO COMPLY MAY IMPACT WEEKLY PROGRESS REPORT
                    </Text>
                </View>
            </View>
        </SafeAreaView>
